...
class pyPrintful:
    ...
    def variant_info(self, pk):
        raise NotImplementedError()

    def product_info(self, pk):
        raise NotImplementedError()
    ...
    def order_info(self, pk):
        raise NotImplementedError()

    def order_cancel(self, pk):
        raise NotImplementedError()

    def order_update(self, pk):
        raise NotImplementedError()

    def order_confirm(self, pk):
        raise NotImplementedError()
    ...
    def syncproduct_info(self, pk):
        raise NotImplementedError()

    def syncproduct_remove(self, pk):
        raise NotImplementedError()

    def syncvariant_info(self, pk):
        raise NotImplementedError()
